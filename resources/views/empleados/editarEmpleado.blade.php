...
@section('content')
<div class="container">
    <h2>Editar Empleado Autorizado</h2>
    <form action="{{ route('empleados.update', $empleado->id_empleado_autorizado) }}" method="POST" id="empleadoForm">
        @csrf
        @method('PUT')
        <div class="mb-3">
            <label for="cedula" class="form-label">Cédula</label>
            <input type="text" name="cedula" id="cedula" class="form-control" value="{{ $empleado->cedula }}" readonly disabled>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="apellido" id="apellido" class="form-control" required value="{{ old('apellido', $empleado->apellido) }}">
        </div>
        <div class="mb-3">
