...
<body>
    <div class="form-container">
        ...
        <form action="{{ route('incidencias.update', $incidencia->id_incidencia) }}" method="POST">
            ...
            <input type="hidden" name="id_lider" value="{{ $incidencia->id_lider }}" class="form-control mb-3"> 
            ...
            <div class="mb-3">
                ...
                <select id="tipo_incidencia" name="tipo_incidencia" class="form-select" required>
                    ...
                    <option value="servida" {{ old('tipo_incidencia', $incidencia->tipo_incidencia) == 'servida' ? 'selected' : '' }}>Servida</option>
                </select>
            </div>
