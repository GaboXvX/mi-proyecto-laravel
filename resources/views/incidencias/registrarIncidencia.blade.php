    ...
    async function cargarEstaciones() {
        ...
        try {
            ...
            if (data.success) {
                ...
                if (data.estaciones.length === 0) {
                    Swal.fire({
                        ...
                        text: 'No hay estaciones disponibles para esta combinación.',
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'Ocurrió un error al cargar las estaciones. Intente nuevamente.',
                confirmButtonText: 'Aceptar'
            });
        }
    }
        ...
        fetch(url)
            ...
            .catch(error => {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: 'Ocurrió un error al cargar las estaciones de apoyo',
                    confirmButtonText: 'Aceptar'
                });
            });
    }
    ...
    btnAgregarItem.addEventListener('click', function() {
        ...
        if (existe) {
            Swal.fire({
                icon: 'warning',
                title: 'Duplicado',
                text: 'Esta combinación ya fue agregada',
                confirmButtonText: 'Aceptar'
            });
            return;
        }
