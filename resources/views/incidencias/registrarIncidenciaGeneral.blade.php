...
<div class="table-container mt-5">
    ...
    <form id="incidenciaGeneralForm" action="{{ route('incidencias.store') }}" method="POST">
        ...
        <div class="step" id="step-1">
            <div class="card mb-3">
                <div class="card-header">
                    <h3 class="mb-0">Dirección del Incidente</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="row g-3 mt-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="punto_de_referencia" name="punto_de_referencia" class="form-control form-control-sm">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-primary btn-sm" id="next-to-step-2">
        ...
        <div class="step d-none" id="step-2">
            <div class="card mb-3">
                <div class="card-header">
                    <h3 class="mb-0">Institución y Estación</h3>
                </div>
                <div class="card-body">
                    <div class="mb-3">
        ...
        <div class="step d-none" id="step-3">
            <div class="card mb-3">
                <div class="card-header">
                    <h3 class="mb-0">Detalles de la Incidencia</h3>
                </div>
                <div class="card-body">
                    <div class="mb-3">
