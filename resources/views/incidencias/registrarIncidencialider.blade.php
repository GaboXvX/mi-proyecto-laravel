...
<body>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('incidencias.store') }}" method="POST">
            ...
            <input type="text" name="id_lider" value="{{ $lider->id_lider}}" class="form-control mb-3" readonly hidden> 
        ...
        <div class="mt-3">
            <a href="{{ route('lideres.index') }}" class="btn btn-link">Ir a la lista de lideres</a>
        </div>
    </div>
