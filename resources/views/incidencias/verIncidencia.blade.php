            ...
            <div class="accordion" id="acordeonPrincipal">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseDescripcion" class="accordion-collapse collapse" aria-labelledby="headingDescripcion" data-bs-parent="#acordeonPrincipal">
                        <div class="accordion-body bg-section p-3 border rounded">
                            {{ $incidencia->descripcion }}
                        </div>
                    </div>
                </div>

                <!-- Reportado por y persona relacionada -->
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingReportado">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseReportado" aria-expanded="false" aria-controls="collapseReportado">
                            <i class="fas fa-users me-2"></i> Reportado por
                        </button>
                    </h2>
                    <div id="collapseReportado" class="accordion-collapse collapse" aria-labelledby="headingReportado" data-bs-parent="#acordeonPrincipal">
                        <div class="accordion-body bg-section">
                            <div class="row">
                                <div class="col-md-6">
