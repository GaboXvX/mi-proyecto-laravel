            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown me-3">
                    <button class="btn btn-light-outline dropdown-toggle d-flex align-items-center" id="bd-theme" type="button" aria-expanded="false" data-bs-toggle="dropdown" aria-label="Cambiar tema">
                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" width="18" height="18" fill="currentColor" class="bi bi-circle-half" viewBox="0 0 16 16">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="bd-theme-text">
                        <li>
                            <button type="button" class="dropdown-item d-flex align-items-center" data-bs-theme-value="light" aria-pressed="false">
                                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" width="18" height="18" fill="currentColor" class="bi bi-sun me-3" viewBox="0 0 16 16">
                        ...
                        <li>
                            <button type="button" class="dropdown-item d-flex align-items-center" data-bs-theme-value="dark" aria-pressed="false">
                                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" width="18" height="18" fill="currentColor" class="bi bi-moon-stars me-3" viewBox="0 0 16 16">
                        ...
                        <li>
                            <button type="button" class="dropdown-item d-flex align-items-center" data-bs-theme-value="auto" aria-pressed="false">
                                <svg xmlns="http://www.w3.org/2000/svg" aria-expanded="true" width="18" height="18" fill="currentColor" class="bi bi-circle-half me-3" viewBox="0 0 16 16">
                                    <path d="M8 15A7 7 0 1 0 8 1zm0 1A8 8 0 1 1 8 0a8 8 0 0 1 0 16"/>
                                </svg>
                                Auto
                            </button>
...
<script>
        ...
        const updateThemeIcon = (theme) => {
            ...
            switch (theme) {
                case 'light':
                    icon.className = 'bi bi-brightness-high me-3';
                    text.textContent = 'Claro';
                    break;
                case 'dark':
                    icon.className = 'bi bi-moon-stars me-3';
                    text.textContent = 'Oscuro';
                    break;
                default:
                    icon.className = 'bi bi-circle-half me-3';
