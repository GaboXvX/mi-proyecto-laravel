...
@section('content')
<div class="container">
    <h1>Editar Personal de Reparación</h1>
    ...
    <form action="{{ route('personal-reparacion.update', $personalReparacion->id_personal_reparacion) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nombre" id="nombre" class="form-control" value="{{ $personalReparacion->nombre }}" required>
        </div>
        
        <div class="form-group">
            <label for="apellido">Apellido</label>
            <input type="text" name="apellido" id="apellido" class="form-control" value="{{ $personalReparacion->apellido }}" required>
        </div>
        
        <div class="form-group">
            <label for="nacionalidad">Nacionalidad</label>
            <input type="text" name="nacionalidad" id="nacionalidad" class="form-control" value="{{ $personalReparacion->nacionalidad }}" required>
        </div>
        
        <div class="form-group">
            <label for="cedula">Cédula</label>
            <input type="text" name="cedula" id="cedula" class="form-control" value="{{ $personalReparacion->cedula }}" required>
        </div>
