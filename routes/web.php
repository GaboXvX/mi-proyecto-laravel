...
Route::group(['middleware' => 'prevent-back-history'],function(){
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('/seguridad/preguntas', [seguridadController::class, 'show'])->name('seguridad.preguntas');
        Route::post('/seguridad/preguntas', [seguridadController::class, 'store'])->name('seguridad.store');
    });
});
